...
/**
 * Custom component to display error messages for the full form, commonly used for server errors
 * @param props
 * @returns
 */
const GeneralFormMessage = memo<GeneralFormMessageProps>(
  function GeneralFormMessage(props) {
